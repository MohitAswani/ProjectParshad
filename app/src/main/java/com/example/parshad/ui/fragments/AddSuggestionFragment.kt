...
class AddSuggestionFragment : BaseFragment() {
    ...
    private lateinit var _binding: FragmentAddSuggestionBinding
    ...
    private fun setListeners() {
        binding.submitBtn.setOnClickListener {
            ...
            val action=AddSuggestionFragmentDirections.actionAddSuggestionFragmentToSuggestionFragment()
